...
/***/ function(module, exports) {
	...
	16-(b-d));d=b+c;return goog.global.setTimeout(function(){a(b+c)},c)};goog.global.cancelAnimationFrame||(goog.global.cancelAnimationFrame=function(a){clearTimeout(a)})}}};goog.events.FocusHandler=function(a){goog.events.EventTarget.call(this);this.element_=a;a=goog.userAgent.IE?"focusout":"blur";this.listenKeyIn_=goog.events.listen(this.element_,goog.userAgent.IE?"focusin":"focus",this,!goog.userAgent.IE);this.listenKeyOut_=goog.events.listen(this.element_,a,this,!goog.userAgent.IE)};goog.inherits(goog.events.FocusHandler,goog.events.EventTarget);goog.events.FocusHandler.EventType={FOCUSIN:"focusin",FOCUSOUT:"focusout"};
	...
	*/
	...
	Blockly.Workspace.prototype.rendered=!1;Blockly.Workspace.prototype.MAX_UNDO=1024;Blockly.Workspace.prototype.refreshToolboxSelection_=function(){};Blockly.Workspace.prototype.dispose=function(){this.listeners_.length=0;this.clear();delete Blockly.Workspace.WorkspaceDB_[this.id]};Blockly.Workspace.SCAN_ANGLE=3;Blockly.Workspace.prototype.addTopBlock=function(a){this.topBlocks_.push(a)};
	...
	Blockly.Workspace.prototype.clear=function(){var a=Blockly.Events.getGroup();for(a||Blockly.Events.setGroup(!0);this.topBlocks_.length;)this.topBlocks_[0].dispose();a||Blockly.Events.setGroup(!1);this.variableMap_.clear();Blockly.DropDownDiv&&Blockly.DropDownDiv.hideWithoutAnimation();Blockly.WidgetDiv&&Blockly.WidgetDiv.hide(!0);this.potentialVariableMap_&&this.potentialVariableMap_.clear()};Blockly.Workspace.prototype.renameVariableById=function(a,b){this.variableMap_.renameVariableById(a,b)};
	Blockly.Workspace.prototype.createVariable=function(a,b,c){return this.variableMap_.createVariable(a,b,c)};Blockly.Workspace.prototype.getVariableUsesById=function(a){return this.variableMap_.getVariableUsesById(a)};Blockly.Workspace.prototype.deleteVariableById=function(a){this.variableMap_.deleteVariableById(a)};Blockly.Workspace.prototype.deleteVariableInternal_=function(a,b){this.variableMap_.deleteVariableInternal_(a,b)};
	Blockly.Workspace.prototype.variableIndexOf=function(){console.warn("Deprecated call to Blockly.Workspace.prototype.variableIndexOf");return-1};Blockly.Workspace.prototype.getVariable=function(a,b){return this.variableMap_.getVariable(a,b)};Blockly.Workspace.prototype.getVariableById=function(a){return this.variableMap_.getVariableById(a)};Blockly.Workspace.prototype.getVariablesOfType=function(a){return this.variableMap_.getVariablesOfType(a)};Blockly.Workspace.prototype.getVariableTypes=function(){return this.variableMap_.getVariableTypes()};
	Blockly.Workspace.prototype.getAllVariables=function(){return this.variableMap_.getAllVariables()};Blockly.Workspace.prototype.getWidth=function(){return 0};Blockly.Workspace.prototype.newBlock=function(a,b){return new Blockly.Block(this,a,b)};
	...
	Blockly.Variables.createVariable=function(a,b,c){if(c==Blockly.BROADCAST_MESSAGE_VARIABLE_TYPE){var d=Blockly.Msg.NEW_BROADCAST_MESSAGE_TITLE;var e=Blockly.Msg.BROADCAST_MODAL_TITLE}else c==Blockly.LIST_VARIABLE_TYPE?(d=Blockly.Msg.NEW_LIST_TITLE,e=Blockly.Msg.LIST_MODAL_TITLE):(c=c?c:"",d=Blockly.Msg.NEW_VARIABLE_TITLE,e=Blockly.Msg.VARIABLE_MODAL_TITLE);var f=Blockly.Variables.nameValidator_.bind(null,c);Blockly.prompt(d,"",function(d){if(d=f(d,a,b)){var e;a.getPotentialVariableMap()&&c&&(e=Blockly.Variables.realizePotentialVar(d,
	c,a,!1));e||(e=a.createVariable(d,c));d=a.isFlyout?a:a.getFlyout();e=e.getId();d.setCheckboxState&&d.setCheckboxState(e,!0);b&&b(e)}else b&&b(null)},e)};Blockly.Variables.nameValidator_=function(a,b,c,d){return a==Blockly.BROADCAST_MESSAGE_VARIABLE_TYPE?Blockly.Variables.validateBroadcastMessageName_(b,c,d):a==Blockly.LIST_VARIABLE_TYPE?Blockly.Variables.validateScalarVarOrListName_(b,c,a,Blockly.Msg.LIST_ALREADY_EXISTS):Blockly.Variables.validateScalarVarOrListName_(b,c,a,Blockly.Msg.VARIABLE_ALREADY_EXISTS)};
	Blockly.Variables.validateBroadcastMessageName_=function(a,b,c){return a?(b=b.getVariable(a,Blockly.BROADCAST_MESSAGE_VARIABLE_TYPE))?(c&&c(b.getId()),null):a:null};Blockly.Variables.validateScalarVarOrListName_=function(a,b,c,d){a=Blockly.Variables.trimName_(a);return a?b.getVariable(a,c)?(Blockly.alert(d.replace("%1",a)),null):a:null};
	...
	"",function(d){var e=g(d,a);e?(a.renameVariableById(b.getId(),e),c&&c(d)):c&&c(null)},f)}};Blockly.Variables.trimName_=function(a){return a?goog.string.trim(a):a};Blockly.Variables.generateVariableFieldXml_=function(a,b){var c=a.type;""==c&&(c="''");return'<field name="'+(b||"VARIABLE")+'" id="'+a.getId()+'" variabletype="'+goog.string.htmlEscape(c)+'">'+goog.string.htmlEscape(a.name)+"</field>"};
	...
	for(d=0;d<b.length;d++)Blockly.DataCategory.addDataList(c,b[d]);0<b.length&&(c[c.length-1].setAttribute("gap",24),b=b[0],Blockly.DataCategory.addAddToList(c,b),Blockly.DataCategory.addDeleteOfList(c,b),Blockly.DataCategory.addInsertAtList(c,b),Blockly.DataCategory.addReplaceItemOfList(c,b),Blockly.DataCategory.addItemOfList(c,b),Blockly.DataCategory.addLengthOfList(c,b),Blockly.DataCategory.addListContainsItem(c,b));return c};
	Blockly.DataCategory.addDataVariable=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_variable","VARIABLE");a[a.length-1].setAttribute("id",b.getId())};Blockly.DataCategory.addSetVariableTo=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_setvariableto","VARIABLE",["VALUE","text",0])};Blockly.DataCategory.addChangeVariableBy=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_changevariableby","VARIABLE",["VALUE","math_number",1])};
	Blockly.DataCategory.addShowVariable=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_showvariable","VARIABLE")};Blockly.DataCategory.addHideVariable=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_hidevariable","VARIABLE")};Blockly.DataCategory.addDataList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_listcontents","LIST");a[a.length-1].setAttribute("id",b.getId())};
	Blockly.DataCategory.addAddToList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_addtolist","LIST",["ITEM","text","thing"])};Blockly.DataCategory.addDeleteOfList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_deleteoflist","LIST",["INDEX","math_integer",1])};Blockly.DataCategory.addInsertAtList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_insertatlist","LIST",["INDEX","math_integer",1],["ITEM","text","thing"])};
	Blockly.DataCategory.addReplaceItemOfList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_replaceitemoflist","LIST",["INDEX","math_integer",1],["ITEM","text","thing"])};Blockly.DataCategory.addItemOfList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_itemoflist","LIST",["INDEX","math_integer",1])};Blockly.DataCategory.addLengthOfList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_lengthoflist","LIST")};
	Blockly.DataCategory.addListContainsItem=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_listcontainsitem","LIST",["ITEM","text","thing"])};Blockly.DataCategory.addShowList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_showlist","LIST")};Blockly.DataCategory.addHideList=function(a,b){Blockly.DataCategory.addBlock(a,b,"data_hidelist","LIST")};
	...
	Blockly.InsertionMarkerManager.prototype.shouldUpdatePreviews_=function(a,b){var c=a.local,d=a.closest,e=a.radius;if(c&&d){if(c.type==Blockly.OUTPUT_VALUE)return!0;if(this.localConnection_&&this.closestConnection_){if(this.closestConnection_==d)return!1;c=this.localConnection_.x_+b.x-this.closestConnection_.x_;var f=this.localConnection_.y_+b.y-this.closestConnection_.y_;c=Math.sqrt(c*c+f*f);return!(d&&e>c-Blockly.CURRENT_CONNECTION_PREFERENCE)}if(this.localConnection_||this.closestConnection_)console.error("Only one of localConnection_ and closestConnection_ was set.");
	...
	Blockly.BlockDragger.prototype.endBlockDrag=function(a,b){this.dragBlock(a,b);this.dragIconData_=[];Blockly.BlockSvg.disconnectUiStop_();var c=this.pixelsToWorkspaceUnits_(b),d=goog.math.Coordinate.sum(this.startXY_,c);this.draggingBlock_.moveOffDragSurface_(d);d=this.wouldDeleteBlock_&&this.draggingBlock_.type==Blockly.PROCEDURES_DEFINITION_BLOCK_TYPE;this.maybeDeleteBlock_()||(this.draggingBlock_.moveConnections_(c.x,c.y),this.draggingBlock_.setDragging(!1),this.draggedConnectionManager_.applyConnections(),
	this.draggingBlock_.render(),this.fireMoveEvent_(),this.draggingBlock_.scheduleSnapAndBump());this.workspace_.setResizesEnabled(!0);this.workspace_.toolbox_&&this.workspace_.toolbox_.removeDeleteStyle();Blockly.Events.setGroup(!1);if(d){var e=this.workspace_;setTimeout(function(){for(var a=e.getAllBlocks(),b=0;b<a.length;b++){var c=a[b];if(c.type==Blockly.PROCEDURES_CALL_BLOCK_TYPE&&(c=c.getProcCode(),!Blockly.Procedures.getDefineBlock(c,e))){alert("To delete a block definition, first remove all uses of the block");
	e.undo();return}}e.refreshToolboxSelection_()})}};Blockly.BlockDragger.prototype.fireMoveEvent_=function(){var a=new Blockly.Events.BlockMove(this.draggingBlock_);a.oldCoordinate=this.startXY_;a.recordNew();Blockly.Events.fire(a)};Blockly.BlockDragger.prototype.maybeDeleteBlock_=function(){var a=this.workspace_.trashcan;this.wouldDeleteBlock_?(a&&goog.Timer.callOnce(a.close,100,a),this.fireMoveEvent_(),this.draggingBlock_.dispose(!1,!0)):a&&a.close();return this.wouldDeleteBlock_};
	...
	Blockly.Grid.createDom=function(a,b,c){a=Blockly.utils.createSvgElement("pattern",{id:"blocklyGridPattern"+a,patternUnits:"userSpaceOnUse"},c);0<b.length&&0<b.spacing&&(Blockly.utils.createSvgElement("line",{stroke:b.colour},a),1<b.length&&Blockly.utils.createSvgElement("line",{stroke:b.colour},a));return a};Blockly.Options=function(a){var b=!!a.readOnly;if(b)var c=null,d=!1,e=!1,f=!1,g=!1,h=!1,k=!1;else!a.toolbox&&Blockly.Blocks.defaultToolbox&&(c=(new DOMParser).parseFromString(Blockly.Blocks.defaultToolbox,"text/xml"),a.toolbox=c.documentElement),c=Blockly.Options.parseToolboxTree(a.toolbox),d=!(!c||!c.getElementsByTagName("category").length),e=a.trashcan,void 0===e&&(e=!1),f=a.collapse,void 0===f&&(f=d),g=a.comments,void 0===g&&(g=d),h=a.disable,void 0===h&&(h=d),k=a.sounds,void 0===k&&(k=!0);var l=
	!!a.rtl,m=a.horizontalLayout;void 0===m&&(m=!1);var n=a.toolboxPosition;n="end"===n?!1:!0;n=m?n?Blockly.TOOLBOX_AT_TOP:Blockly.TOOLBOX_AT_BOTTOM:n==l?Blockly.TOOLBOX_AT_RIGHT:Blockly.TOOLBOX_AT_LEFT;var p=a.scrollbars;void 0===p&&(p=d);var q=a.css;void 0===q&&(q=!0);var u="https://blockly-demo.appspot.com/static/media/";a.media?u=a.media:a.path&&(u=a.path+"media/");var w=void 0===a.oneBasedIndex?!0:!!a.oneBasedIndex,v=!!a.realtime,x=v?a.realtimeOptions:void 0,r=a.colours;if(r)for(var t in r)r.hasOwnProperty(t)&&
	Blockly.Colours.hasOwnProperty(t)&&(Blockly.Colours[t]=r[t]);this.RTL=l;this.oneBasedIndex=w;this.collapse=f;this.comments=g;this.disable=h;this.readOnly=b;this.pathToMedia=u;this.hasCategories=d;this.hasScrollbars=p;this.hasTrashcan=e;this.hasSounds=k;this.hasCss=q;this.horizontalLayout=m;this.languageTree=c;this.gridOptions=Blockly.Options.parseGridOptions_(a);this.zoomOptions=Blockly.Options.parseZoomOptions_(a);this.enableRealtime=v;this.realtimeOptions=x;this.toolboxPosition=n};
	...
	Blockly.Xml.domToBlock=function(a,b){if(a instanceof Blockly.Workspace){var c=a;a=b;b=c;console.warn("Deprecated call to Blockly.Xml.domToBlock, swap the arguments.")}Blockly.Events.disable();c=b.getAllVariables();try{var d=Blockly.Xml.domToBlockHeadless_(a,b),e=d.getDescendants();if(b.rendered){d.setConnectionsHidden(!0);for(var f=e.length-1;0<=f;f--)e[f].initSvg();for(f=e.length-1;0<=f;f--)e[f].render(!1);b.isFlyout||setTimeout(function(){d.workspace&&d.setConnectionsHidden(!1)},1);d.updateDisabled();
	b.resizeContents()}else for(f=e.length-1;0<=f;f--)e[f].initModel()}finally{Blockly.Events.enable()}if(Blockly.Events.isEnabled()){e=Blockly.Variables.getAddedVariables(b,c);for(f=0;f<e.length;f++)Blockly.Events.fire(new Blockly.Events.VarCreate(e[f]));Blockly.Events.fire(new Blockly.Events.BlockCreate(d))}return d};
	...
	Blockly.WorkspaceSvg.prototype.paste=function(a){if(this.rendered){this.currentGesture_&&this.currentGesture_.cancel();Blockly.Events.disable();try{var b=Blockly.Xml.domToBlock(a,this);Blockly.utils.changeObscuredShadowIds(b);var c=parseInt(a.getAttribute("x"),10),d=parseInt(a.getAttribute("y"),10);if(!isNaN(c)&&!isNaN(d)){this.RTL&&(c=-c);do{a=!1;for(var e=this.getAllBlocks(),f=0,g;g=e[f];f++){var h=g.getRelativeToSurfaceXY();if(1>=Math.abs(c-h.x)&&1>=Math.abs(d-h.y)){a=!0;break}}if(!a){var k=b.getConnections_(!1);
	...
	!1,h=!1,k=0;k<d.length;k++)for(var l=d[k];l;)l.isCollapsed()?g=!0:h=!0,l=l.getNextBlock();c.push(Blockly.ContextMenu.wsCollapseOption(h,d));c.push(Blockly.ContextMenu.wsExpandOption(g,d))}var m=Blockly.WorkspaceSvg.buildDeleteList_(d),n=0;for(k=0;k<m.length;k++)m[k].isShadow()||n++;d={text:1==n?Blockly.Msg.DELETE_BLOCK:Blockly.Msg.DELETE_X_BLOCKS.replace("%1",String(n)),enabled:0<n,callback:function(){f.currentGesture_&&f.currentGesture_.cancel();2>m.length?b():Blockly.confirm(Blockly.Msg.DELETE_ALL_BLOCKS.replace("%1",
	...
	Blockly.Field.prototype.argType_=null;Blockly.Field.prototype.validator_=null;Blockly.Field.NBSP="\u00a0";Blockly.Field.IE_TEXT_OFFSET="0.3em";Blockly.Field.prototype.EDITABLE=!0;Blockly.Field.prototype.SERIALIZABLE=!0;Blockly.Field.prototype.setSourceBlock=function(a){goog.asserts.assert(!this.sourceBlock_,"Field already bound to a block.");this.sourceBlock_=a};
	...
	Blockly.FieldLabelSerializable.prototype.render_=function(){if(this.visible_&&this.textElement_){goog.dom.removeChildren(this.textElement_);var a=document.createTextNode(this.getDisplayText_());this.textElement_.appendChild(a);this.updateWidth();a=this.size_.width/2;var b=Blockly.BlockSvg.FIELD_WIDTH/2;a=this.sourceBlock_.RTL?Math.min(this.size_.width-b,a):Math.max(b,a);this.textElement_.setAttribute("x",a)}};Blockly.FieldVariableGetter=function(a,b,c){this.size_=new goog.math.Size(Blockly.BlockSvg.FIELD_WIDTH,Blockly.BlockSvg.FIELD_HEIGHT);this.text_=a;this.maxDisplayLength=Blockly.BlockSvg.MAX_DISPLAY_LENGTH;this.name_=b;this.variableType_=c?c:""};goog.inherits(Blockly.FieldVariableGetter,Blockly.Field);Blockly.FieldVariableGetter.prototype.EDITABLE=!1;Blockly.FieldVariableGetter.prototype.SERIALIZABLE=!0;
	Blockly.FieldVariableGetter.prototype.init=function(){if(!this.fieldGroup_&&(Blockly.FieldVariableGetter.superClass_.init.call(this),!this.variable_)){this.workspace_=this.sourceBlock_.workspace;var a=Blockly.Variables.getOrCreateVariablePackage(this.workspace_,null,this.text_,this.variableType_);this.setValue(a.getId())}};Blockly.FieldVariableGetter.prototype.getValue=function(){return this.variable_?this.variable_.getId():""};
	Blockly.FieldVariableGetter.prototype.getText=function(){return this.variable_?this.variable_.name:""};Blockly.FieldVariableGetter.prototype.getVariable=function(){return this.variable_};
	...
	Blockly.Input.prototype.initOutlinePath=function(a){this.type==Blockly.INPUT_VALUE&&(this.outlinePath=Blockly.utils.createSvgElement("path",{"class":"blocklyPath",style:"visibility: hidden",d:""},a))};Blockly.Warning=function(a){Blockly.Warning.superClass_.constructor.call(this,a);this.createIcon();this.text_={}};goog.inherits(Blockly.Warning,Blockly.Icon);Blockly.Warning.prototype.collapseHidden=!1;
	...
	b[c];c++)a.render()}};Blockly.BlockSvg.prototype.tab=function(a,b){var c=this.createTabList_(),d=c.indexOf(a);-1==d&&(d=b?-1:c.length);(c=c[b?d+1:d-1])?c instanceof Blockly.Field?c.showEditor_():c.tab(null,b):(c=this.outputConnection&&this.outputConnection.targetBlock())?c.tab(this,b):(c=b?this.getNextBlock():this.getPreviousBlock())&&c.tab(this,b)};
	...
	"translate("+d+","+e+")")}};Blockly.FieldAngle.prototype.classValidator=function(a){if(null===a)return null;a=parseFloat(a||0);if(isNaN(a))return null;a%=360;0>a&&(a+=360);a>Blockly.FieldAngle.WRAP&&(a-=360);return String(a)};Blockly.FieldCheckbox=function(a,b){Blockly.FieldCheckbox.superClass_.constructor.call(this,"",b);this.setValue(a);this.addArgType("checkbox")};goog.inherits(Blockly.FieldCheckbox,Blockly.Field);Blockly.FieldCheckbox.CHECK_CHAR="\u2713";Blockly.FieldCheckbox.prototype.CURSOR="default";
	...
	Blockly.FieldColourSlider.prototype.setGradient_=function(a,b){var c=this.createColourStops_(b).join(",");goog.style.setStyle(a,"background","-moz-linear-gradient(left, "+c+")");goog.style.setStyle(a,"background","-webkit-linear-gradient(left, "+c+")");goog.style.setStyle(a,"background","-o-linear-gradient(left, "+c+")");goog.style.setStyle(a,"background","-ms-linear-gradient(left, "+c+")");goog.style.setStyle(a,"background","linear-gradient(left, "+c+")")};
	...
	Blockly.FieldImage.prototype.setText=function(a){null!==a&&(this.text_=a)};Blockly.FieldImage.prototype.render_=function(){};Blockly.FieldImage.prototype.updateWidth=function(){};Blockly.FieldTextInputRemovable=function(a,b,c){Blockly.FieldTextInputRemovable.superClass_.constructor.call(this,a,b,c)};goog.inherits(Blockly.FieldTextInputRemovable,Blockly.FieldTextInput);
	...
	Blockly.FieldVariable.prototype.onItemSelected=function(a,b){var c=b.getValue();if(this.sourceBlock_&&this.sourceBlock_.workspace){var d=this.sourceBlock_.workspace;if(c==Blockly.RENAME_VARIABLE_ID){Blockly.Variables.renameVariable(d,this.variable_);return}if(c==Blockly.DELETE_VARIABLE_ID){d.deleteVariableById(this.variable_.getId());return}if(c==Blockly.NEW_BROADCAST_MESSAGE_ID){var e=this;Blockly.Variables.createVariable(d,function(a){a&&e.setValue(a)},Blockly.BROADCAST_MESSAGE_VARIABLE_TYPE);return}}this.setValue(c)};/*
	 ...
	 limitations under the License.
	*/
	Blockly.FieldVerticalSeparator=function(){this.sourceBlock_=null;this.width_=1;this.height_=Blockly.BlockSvg.ICON_SEPARATOR_HEIGHT;this.size_=new goog.math.Size(this.width_,this.height_)};goog.inherits(Blockly.FieldVerticalSeparator,Blockly.Field);Blockly.FieldVerticalSeparator.prototype.EDITABLE=!1;
	...
	Blockly.Procedures.allProcedureMutations=function(a){a=a.getAllBlocks();for(var b=[],c=0;c<a.length;c++)if(a[c].type==Blockly.PROCEDURES_PROTOTYPE_BLOCK_TYPE){var d=a[c].mutationToDom();d&&b.push(d)}return b};Blockly.Procedures.sortProcedureMutations_=function(a){a=a.slice();a.sort(function(a,c){var b=a.getAttribute("proccode"),e=c.getAttribute("proccode");return b<e?-1:b>e?1:0});return a};Blockly.Procedures.procTupleComparator_=function(a,b){return a[0].toLowerCase().localeCompare(b[0].toLowerCase())};
	...
	Blockly.Procedures.getCallers=function(a,b,c,d){var e=[],f=b.getTopBlocks();for(b=0;b<f.length;b++){var g=f[b];(g.id!=c.id||d)&&e.push.apply(e,g.getDescendants())}c=[];for(b=0;b<e.length;b++)g=e[b],g.type==Blockly.PROCEDURES_CALL_BLOCK_TYPE&&(d=g.getProcCode())&&d==a&&c.push(g);return c};
	...
	Blockly.Procedures.getDefineBlock=function(a,b){for(var c=b.getTopBlocks(!1),d=0;d<c.length;d++)if(c[d].type==Blockly.PROCEDURES_DEFINITION_BLOCK_TYPE){var e=c[d].getInput("custom_block").connection.targetBlock();if(e.getProcCode&&e.getProcCode()==a)return c[d]}return null};Blockly.Procedures.getPrototypeBlock=function(a,b){var c=Blockly.Procedures.getDefineBlock(a,b);return c?c.getInput("custom_block").connection.targetBlock():null};Blockly.Procedures.newProcedureMutation=function(){return Blockly.Xml.textToDom('<xml><mutation proccode="block name" argumentids="[]" argumentnames="[]" argumentdefaults="[]" warp="false"></mutation></xml>').firstChild};
	...
	Blockly.Css.inject=function(a,b){if(!Blockly.Css.styleSheet_){var c=".blocklyDraggable {}\n";a&&(c+=Blockly.Css.CONTENT.join("\n"),Blockly.FieldDate&&(c+=Blockly.FieldDate.CSS.join("\n")));Blockly.Css.mediaPath_=b.replace(/[\\\/]$/,"");c=c.replace(/<<<PATH>>>/g,Blockly.Css.mediaPath_);for(var d in Blockly.Colours)Blockly.Colours.hasOwnProperty(d)&&(c=c.replace(new RegExp("\\$colour\\_"+d,"g"),Blockly.Colours[d]));d=document.createElement("style");document.head.insertBefore(d,document.head.firstChild);
	...
	"stroke: "+Blockly.Colours.motion.tertiary+";","stroke-width: 1;","fill: "+Blockly.Colours.motion.secondary+";","}",".blocklyAngleCenterPoint {","stroke: #fff;","stroke-width: 1;","fill: #fff;","}",".blocklyAngleDragHandle {","stroke: #fff;","stroke-width: 5;","stroke-opacity: 0.25;","fill: #fff;","cursor: pointer;","}",".blocklyAngleMarks {","stroke: #fff;","stroke-width: 1;","stroke-opacity: 0.5;","}",".blocklyAngleGauge {","fill: #fff;","fill-opacity: 0.20;","}",".blocklyAngleLine {","stroke: #fff;",
	"stroke-width: 1;","stroke-linecap: round;","pointer-events: none;","}",".blocklyContextMenu {","border-radius: 4px;","}",".blocklyDropdownMenu {","padding: 0 !important;","}",".blocklyDropDownNumPad {","background-color: $colour_numPadBackground;","}",".blocklyWidgetDiv .goog-option-selected .goog-menuitem-checkbox,",".blocklyWidgetDiv .goog-option-selected .goog-menuitem-icon {","background: url(<<<PATH>>>/sprites.png) no-repeat -48px -16px !important;","}",".blocklyToolboxDiv {","background-color: $colour_toolbox;",
	...
	"}",".blocklyWidgetDiv .goog-menuitem-highlight,",".blocklyWidgetDiv .goog-menuitem-hover {","background-color: #d6e9f8;","border-color: #d6e9f8;","border-style: dotted;","border-width: 1px 0;","padding-bottom: 3px;","padding-top: 3px;","}",".blocklyDropDownDiv .goog-menuitem-highlight,",".blocklyDropDownDiv .goog-menuitem-hover {","background-color: rgba(0, 0, 0, 0.2);","}",".blocklyWidgetDiv .goog-menuitem-checkbox,",".blocklyWidgetDiv .goog-menuitem-icon, ",".blocklyDropDownDiv .goog-menuitem-checkbox,",
	...
	"}",".scratchCategoryMenu {","width: 52px;","background: $colour_toolbox;","color: $colour_toolboxText;","font-size: .7rem;","user-select: none;","-webkit-user-select: none;","-moz-user-select: none;","-ms-user-select: none;","}",".scratchCategoryMenuHorizontal {","width: 100%;","height: 50px;","background: $colour_toolbox;","color: $colour_toolboxText;","font-size: .7em;","user-select: none;","-webkit-user-select: none;","-moz-user-select: none;","-ms-user-select: none;","}",".scratchCategoryMenuHorizontal .scratchCategoryMenuRow {",
	"float: left;","margin: 3px;","}",".scratchCategoryMenuRow {","}",".scratchCategoryMenuItem {","padding: 0.375rem 0px;","cursor: pointer;","text-align: center;","}",".scratchCategoryMenuHorizontal .scratchCategoryMenuItem {","padding: 6px 5px;","}",".scratchCategoryMenuItem.categorySelected {","background: $colour_toolboxSelected;","}",".scratchCategoryItemBubble {","width: 1.25rem;","height: 1.25rem;","border: 1px solid;","border-radius: 100%;","margin: 0 auto 0.125rem;","}",".scratchCategoryItemIcon {",
	...
	Blockly.inject.loadSounds_=function(a,b){var c=b.getAudioManager();c.load([a+"click.mp3",a+"click.wav",a+"click.ogg"],"click");c.load([a+"delete.mp3",a+"delete.ogg",a+"delete.wav"],"delete");var d=[],e=function(){for(;d.length;)Blockly.unbindEvent_(d.pop());c.preload()};d.push(Blockly.bindEventWithChecks_(document,"mousemove",null,e,!0));d.push(Blockly.bindEventWithChecks_(document,"touchstart",null,e,!0))};
